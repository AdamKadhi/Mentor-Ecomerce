...
const Home = () => {
  ...
  useEffect(()=>{
    indeximage<0 ?setindeximage(3): indeximage>3?setindeximage(0):
  ...
  return (
    <div className="home">
                ...
                {addCart && quantity > 0 ? (
                  <div className="non_empty_cart cart_drop_cont">
                    <div className="cart_product">
                      ...
                      <img src={deletee} alt="" id="delete" onClick={()=>setquantity(0)} />
                    </div>
      ...
      <div className="image_modal">
        <img src={close} alt="" id="close" onClick={()=>setshowmodal(false)} />
      ...
      :null}
        ...
        <div className="images">
          ...
          <img src={imagess[indeximage]} alt="" className="product_img" onClick={()=>setshowmodal(true)} />
          <div className="product_small_images">
            <img
              src={image_product_1}
              alt=""
        ...
        <div className="desc">
          ...
          <div className="cart_count_add">
            ...
            <button className="add_button" onClick={() => quantity>0?setaddCart(true):null}>
              {" "}
